$(function () {
    ...
    function init() {
        ...
        $('#Tz_styleBtn li').on('click', function () {
    ...
    function Helix() {
        var roY = 10, tY = 10;
        var mIndex = Math.floor($('#Tz_main li').length / 2);
    ...
    (function () {
        var $Tz_mainLi = $('#Tz_main li');
        var $show = $('#Tz_show');
        $Tz_mainLi.click(function (ev) {
            ev = ev || window.event;
...
(function () {
    var demoArr = [
        {title: 'Js', author: '阿飞', date: '2016.03.03', kt: '阿飞老师我爱你', src: 'demo/3D drag'},
        {title: 'Js', author: '阿飞', date: '2016.03.03'},
        {title: 'Js', author: '阿飞', date: '2016.03.03'},
        {title: 'Js', author: '阿飞', date: '2016.03.03'},
        {title: 'Js', author: '阿飞', date: '2016.03.03'},
        {title: 'Js', author: '阿飞', date: '2016.03.03'},
